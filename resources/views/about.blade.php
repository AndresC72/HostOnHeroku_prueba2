				...
				<!-- Main -->
					...
					<section class="page-section bg-light" id="team">
						<div class="container">
							...
							<div class="row">
								<div class="col-lg-12">
									<div class="team-member">
										...
										<p class="text-muted">Programador y diseñador de interfaces</p>
							...
							<div class="row">
								<div class="col-lg-12 mx-auto text-center"><p class="large text-muted">Puede contactarme por medio de los links de esta pagina.</p></div>
							</div>
						</div>
					</section>
				<!-- Footer -->
